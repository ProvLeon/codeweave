        ...
        <Card className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="text-light-text dark:text-gray-200">
            ...
            <CardFooter className='flex flex-col gap-2'>
              ...
              <p className='text-light-text dark:text-dark-text'>Don&apos;t have an account? <Link href="/sign-up" className='hover:underline text-blue-600 dark:hover:text-gray-400'>Sign Up</Link></p>
            </CardFooter>
          </form>
        </Card>
      </div>
